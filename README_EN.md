...
This guide documents a **working setup** for the **FocalTech FTE3600** fingerprint sensor on the **KVADRA NAU LE14U** laptop running **Ubuntu 25.10**.

This is not a generic guide for all FocalTech devices. It is a practical, tested configuration for this exact hardware and OS combination.
